...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($appointment_date) || empty($status)) {
        ...
        if ($update->execute()) {
            header("Location: doctor_dashboard.php?update=success");
            exit();
        } else {
...
<div class="container">
    ...
    <form method="POST" onsubmit="return confirmUpdate();">
        ...
        <div class="form-group">
            ...
            <textarea name="message"><?= safe_html($appointment['message']) ?></textarea>
        </div>

        <div class="form-group">
            <label>Doctor’s Comment</label>
            <textarea name="comment" placeholder="Add any notes or updates..."><?= safe_html($appointment['comment']) ?></textarea>
        </div>

        <div class="btn-container">
            <button type="button" class="btn btn-secondary" onclick="window.location.href='doctor_dashboard.php'">Cancel</button>
