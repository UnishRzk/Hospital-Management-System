...
<title>Bed Booking — SwasthyaTrack</title>
...
<div class="form-container">
  ...
  <?php if (empty($available_beds)): ?>
      <p class="alert-error">🚫 Sorry, no private beds are available for booking at the moment. Please check again later.</p>
  <?php else: ?>
...
<div class="modal" id="successModal">
  <div class="modal-content">
      ...
      <p>Your private bed has been successfully reserved. We will contact you with admission details shortly.</p>
